<template>
  <div class="hero min-h-screen justify-start mx-auto max-w-5xl">
    <div class="hero-content text-left">
      <div>
        <p class="text-8xl ">Zhi Zeng
  ...
  <div class="hero min-h-screen justify-start mx-auto max-w-5xl">
    <div class="hero-content text-left">
      <div>
        <p class="text-5xl my-8">Hi, I am Zhi Zeng, a frontend developer currently living in Melbourne.</p>
