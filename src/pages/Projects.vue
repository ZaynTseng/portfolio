  ...
  <div class="flex flex-col gap-3">
    <router-link to="/portfolio/projects/plant-mate"
      ...
      <div class="flex flex-col mt-16 mb-4 items-center gap-y-1 md:gap-y-1.5 lg:gap-y-2">
        ...
        <p class="text-xl md:text-2xl lg:text-3xl font-light text-center">A digital twin app crafted for novice urban&nbsp;farmers</p>
    ...
    <router-link to="/portfolio/projects/stereo-disparity"
      ...
      <div class="flex flex-col mt-16 mb-8 items-center gap-y-1 md:gap-y-1.5 lg:gap-y-2">
        ...
        <p class="text-xl md:text-2xl lg:text-3xl font-light text-center">Stereo disparity algorithm experiments and&nbsp;evaluation</p>
        <div class="text-md md:text-lg lg:text-xl flex text-blue-500 gap-1">
          <p class="link link-hover">Read</p>
          <p>→</p>
        </div>
