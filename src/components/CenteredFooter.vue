<template>
  <div class="bg-neutral text-neutral-content">
    ...
    <footer class="footer px-10 py-4 border-t border-gray-800 mx-auto max-w-5xl flex justify-between">
      <aside>
        <p>© 2023 Zhi Zeng. All Rights Reserved.</p>
      </aside>
      <div class="grid grid-flow-col gap-4">
        <a href="https://twitter.com/ZaynTseng">
        ...
        <a href="https://github.com/ZaynTseng">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512" class="fill-current">
            <path
        ...
        <a href="https://www.linkedin.com/in/zhizeng/">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512" class="fill-current">
            <path
